...
$(document).ready(function(){
    ...
    var mentors = [ new Mentor("Phil Nash","Twilio","Ruby, Javascript & APIs","@philnash"),
                    ...
                    new Mentor("Lou Lemaistre","The Family","Operations / Growth Hacking / Community","@Lou_mstr"),
                    ...
                    new Mentor("Serge Alleyne","TheFamily","UX / Product / Design / Entrepreneurship","@salleyne"),
...
$(document).ready(function(){
  ...
  var events = [  new Event("Get Your Tickets Now","April 10, 2017 15:09:58","--"),
                  ...
                  new Event("Intro to Fusion 360","April 22, 2017 14:00:00","..."),
                  new Event("Visuals with P5.js Workshop","April 22, 2017 15:00:00","..."),
                  new Event("Intro to Spotify Platform - Workshop","April 22, 2017 16:00:00","..."),
                  ...
                  new Event("Communities - Sengrid Talk/Panel/Workshop","April 22, 2017 21:00:00","..."),
  ...
  for (i=events.length-2; i>=1;i--){
    var hr=Math.floor((events[i].time % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60))+1;
